<?php
	...
	<form action="login-shirt.php" method="post">
			<center>
				<table>
					<tr>
					...
					<tr>
						<td style="color: white; font-family:arial,sans-serif; -webkit-font-smoothing:antialiased; font-size:120%;">Size : '.$shirt.' </td>
					</tr>
				</table>
		...
		<br>
		<hr style="color: white; border:1px dotted white;">
		<form action="validate_shirt.php" name="newregistration" onsubmit="return(validate());" method="post" >
		<div class="container">
			<center>
